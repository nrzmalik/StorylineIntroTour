...
function nrzIntroTour(language) {
  var translations = {
    intro: {
	  ...
	  german: 'Herzlich willkommen im Kurs! Dies ist der Bereich, in dem der Kursinhalt angezeigt wird. Verwenden Sie die Navigationsknöpfe, um zwischen den Folien zu wechseln.'
    },
    resources: {
	  ...
	  german: 'Hier finden Sie hilfreiche Ressourcen zum Kurs. Klicken Sie auf die Links, um zusätzliches Material oder Verweise abzurufen.'
    },
    menu: {
	  ...
	  german: 'Das Kursmenü befindet sich hier. Es bietet einen Überblick über die Kursstruktur und ermöglicht es Ihnen, zu bestimmten Abschnitten oder Modulen zu springen.'
    },
    playback: {
	  ...
	  german: 'Mit diesen Steuerelementen können Sie die Wiedergabe der Folien starten oder anhalten. Sie können das Tempo des Kursinhalts nach Ihren Vorlieben steuern.'
    },
    next: {
	  ...
	  german: 'Um zur nächsten Folie zu gelangen, klicken Sie auf die Schaltfläche "Weiter". Sie gelangen zum nächsten Thema oder Modul im Kurs.'
    },
    prev: {
	  ...
	  german: 'Wenn Sie zur vorherigen Folie zurückkehren möchten, verwenden Sie die Schaltfläche "Zurück". Sie werden zum vorherigen Thema oder Modul navigiert.'
    },
    titles: {
      english: {
        slide: 'Slide',
	  ...
	  german: {
        ...
        next: 'Schaltfläche für die nächste Folie',
        prev: 'Schaltfläche für die vorherige Folie'
      }
    }
  }
...
/// Without SeekBar nrzIntroTourWithoutSeekbar
